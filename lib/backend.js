...
var SUBCLID = 0;    //  global autokey for pubsub clients
...
exports.Backend = function ()
{
    ...
    this.pub = function ( channel, message )
    {
        ...
        for ( i = 0; i < n; i ++ )
        {
            ...
            if ( !sub.client.$SUBCLID )
                sub.client.$SUBCLID = 'SUB' + ( SUBCLID ++ );
...
exports.Backend.prototype =
{
    ...
    bArgs : function ( arguments )
    {
        var args = arr ( arguments ), timeout = str2int ( args.pop () || "FAIL" );
