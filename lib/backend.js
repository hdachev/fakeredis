...
, SCAN: function() {
    var cursor = str2int(arguments[0]);
    ...
    var opt1 = (arguments[1] || '').toUpperCase();
    var opt2 = (arguments[3] || '').toUpperCase();
    if (opt1 === 'MATCH') {
      matchPattern = pattern(arguments[2]);
      if (opt2 === 'COUNT')
        count = str2int(arguments[4]);
      else if (opt2)
        return BAD_SYNTAX;
    }
    else if (opt1 === 'COUNT') {
